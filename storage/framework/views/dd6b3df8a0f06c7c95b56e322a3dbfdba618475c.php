                    ...
                    <div class="d-flex align-items-center">
                        <div class="menu-block">
                            <ul class="menu-list">
                                ...
                                <li class="menu-item"><a href="#features"><?php echo e(__('Space Available')); ?></a></li>
...
<section class="intro" id="demos">
                ...
                <div class="intro-contain">
                    <div>
                        <h1 class="wow fadeInLeft"
                            data-wow-duration="1s"><?php echo e(__('TANGANYIKA FARMERS ASSOCIATION (TFA)')); ?></h1>
                        <p class="wow fadeInLeft"
                           data-wow-duration="1.5s"><?php echo e(__('TFA Plc owns different Properties in strategic areas where Tanzanians can be able to open up different Entrepreneur Activities. “TFA PLAZA”')); ?></p>
    ...
    <div class="landing_dash">
        <img class="" src="<?php echo e(asset('assets/images/landing/tfa.jpg')); ?>" alt="">
    </div>
</section>
<!-- intro end-->
<!-- demo start-->
        ...
        <div class="row cdx-row justify-content-center">
            <div class="ecompro-slide arrow-style1">
                <div>
                    <div class="card ecom-product">
                        <div class="card-body p-10">
                            <div class="product-imgwrap"><img style="height: 100px" class="img-fluid"
                                                              src="<?php echo e(asset('assets/images/landing/prime_location.png')); ?>"
                                                              alt="1.jpg"></div>
                            <div class="detail-wrap">
                                <a href="#">
                                    <h5><?php echo e(__('Prime Location')); ?></h5>
                                    <p><?php echo e(__('Located in a prime area, making it easily accessible for employees, clients, and suppliers. High visibility location can attract more foot traffic and enhance brand presence.')); ?></p>
                                </a>
                            </div>
                        </div>
                    </div>
                ...
                <div>
                    <div class="card ecom-product">
                        <div class="card-body p-10">
                            <div class="product-imgwrap"><img style="height: 180px"  class="img-fluid"
                                                              src="<?php echo e(asset('assets/images/landing/flexibility.png')); ?>"
                                                              alt="1.jpg"></div>
                            <div class="detail-wrap">
                                <a href="#">
                                    <h5><?php echo e(__('Flexibility')); ?></h5>
                                    <p><?php echo e(__('Options to customize the office space according to the specific needs of the business. Offering flexible lease terms to accommodate the growth and changes in the business.')); ?></p>
                                </a>
                            </div>
                        </div>
                    </div>
                ...
                <div>
                    <div class="card ecom-product">
                        <div class="card-body p-10">
                            <div class="product-imgwrap"><img style="height: 180px" class="img-fluid"
                                                              src="<?php echo e(asset('assets/images/landing/cost_effective.jpeg')); ?>"
                                                              alt="1.jpg"></div>
                            <div class="detail-wrap">
                                <a href="#">
                                    <h5><?php echo e(__('Cost-Effective')); ?></h5>
                                    <p><?php echo e(__('Affordable rental rates compared to other properties in the area. Utilities, maintenance, and security included in the rental package, reducing additional costs.')); ?></p>
                                </a>
                            </div>
                        </div>
                    </div>
                ...
                <div>
                    <div class="card ecom-product">
                        <div class="card-body p-10">
                            <div class="product-imgwrap"><img style="height: 180px" class="img-fluid"
                                                              src="<?php echo e(asset('assets/images/landing/support.png')); ?>"
                                                              alt="1.jpg"></div>
                            <div class="detail-wrap">
                                <a href="#">
                                    <h5><?php echo e(__('Support Services')); ?></h5>
                ...
                <div>
                    <div class="card ecom-product">
                        <div class="card-body p-10">
                            <div class="product-imgwrap"><img style="height: 180px" class="img-fluid"
                                                              src="<?php echo e(asset('assets/images/landing/convenience.png')); ?>"
                                                              alt="1.jpg"></div>
                            <div class="detail-wrap">
                                <a href="#">
                                    <h5><?php echo e(__('Convenience')); ?></h5>
                                    <p><?php echo e(__('Property management refers to the administration, operation, and oversight of real estate properties on behalf of property owners.')); ?></p>
                                </a>
                            </div>
                        </div>
                ...
                <div class="col-xxl-3 cdx-xl-50 col-sm-6">
                    <div class="codex-pricingtbl">
                        <div class="price-header">
                            ...
                            <div class="price-value"><?php echo e(subscriptionPaymentSettings()['CURRENCY_SYMBOL']); ?>10<span>/ M square</span></div>
                        </div>
            ...
            <?php $__currentLoopData = $subscriptions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subscription): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="col-xxl-3 cdx-xl-50 col-sm-6">
                    <div class="codex-pricingtbl">
                        <div class="price-header">
                            <h2><?php echo e($subscription->title); ?></h2>
                            <div class="price-value"><?php echo e(subscriptionPaymentSettings()['CURRENCY_SYMBOL']); ?>20<span>/ M square</span></div>
                        </div>
            ...
            <?php $__currentLoopData = $subscriptions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subscription): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="col-xxl-3 cdx-xl-50 col-sm-6">
                    <div class="codex-pricingtbl">
                        <div class="price-header">
                            <h2><?php echo e($subscription->title); ?></h2>
                            <div class="price-value"><?php echo e(subscriptionPaymentSettings()['CURRENCY_SYMBOL']); ?>30<span>/ M square</span></div>
                        </div>
            ...
            <?php $__currentLoopData = $subscriptions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subscription): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="col-xxl-3 cdx-xl-50 col-sm-6">
                    <div class="codex-pricingtbl">
                        <div class="price-header">
                            <h2><?php echo e($subscription->title); ?></h2>
                            <div class="price-value"><?php echo e(subscriptionPaymentSettings()['CURRENCY_SYMBOL']); ?>40<span>/ M square</span></div>
                        </div>
...
<section class="space-py-100" id="features">
    <div class="container">
        <div class="row">
            <div class="col-lg-8 offset-lg-2 col-md-10 offset-md-1">
                <div class="land-title">
                    <h2 class="wow fadeInUp" data-wow-duration="1s"><?php echo e(__('SPACE AVAILABLE')); ?> </h2>
                </div>
            </div>
        </div>
        <div class="row cdx-row">
            <div class="col-lg-4 col-md-6 wow fadeInUp">
                <div class="demo-grid">
                    <div class="img-wrap"><img class="img-fluid"
                                               src="<?php echo e(asset('assets/images/landing/room1.jpeg')); ?>"
                                               alt="">
                        <div class="group-link"><a class="hover-link"
                                                   href="javascript:void(0);"><img
                                    class="img-fluid"
                                    src="<?php echo e(asset('assets/images/landing/room2.jpeg')); ?>"
            ...
            <div class="col-lg-4 col-md-6 wow fadeInUp">
                <div class="demo-grid">
                    <div class="img-wrap"><img class="img-fluid"
                                               src="<?php echo e(asset('assets/images/landing/room3.jpeg')); ?>"
                                               alt="">
                        <div class="group-link"><a class="hover-link"
                                                   href="javascript:void(0);"><img
                                    class="img-fluid"
...
<section class="landheader-comp space-py-100 overflow-visible" id="faq">
    <div class="container">
        <div class="row">
            <div class="col-lg-8 offset-lg-2 col-md-10 offset-md-1">
                <div class="land-title">
                    <h2 class="wow fadeInLeft"><?php echo e(__(' Ask Questions?')); ?></h2>
                </div>
            </div>
        </div>
        <div class="row pricing-grid">
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/project/propertymanagement/resources/views/layouts/landing.blade.php ENDPATH**/ ?>