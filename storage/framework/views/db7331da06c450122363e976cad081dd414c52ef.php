        ...
        <tr class="bg-white">
            <td>   <div class="imgwrapper">
                <a class="hover-link" href="<?php echo e(route('property.show',$property->id)); ?>"><i
                    ...
                    <td> <a href="<?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('show property')): ?> <?php echo e(route('property.show',$property->id)); ?> <?php endif; ?>">
            ...
            <td> <ul class="blogsoc-list">
                <li><a href="#"><i data-feather="layers"></i><?php echo e($property->totalUnit()); ?>  <?php echo e(__('Space')); ?></a></li>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/project/propertymanagement/resources/views/property/index.blade.php ENDPATH**/ ?>