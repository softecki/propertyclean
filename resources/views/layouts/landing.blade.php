                    ...
                    <div class="d-flex align-items-center">
                        <div class="menu-block">
                            <ul class="menu-list">
                                ...
                                <li class="menu-item"><a href="#features">{{__('Space Available')}}</a></li>
...
<section class="intro" id="demos">
                ...
                <div class="intro-contain">
                    <div>
                        <h1 class="wow fadeInLeft"
                            data-wow-duration="1s">{{__('TANGANYIKA FARMERS ASSOCIATION (TFA)')}}</h1>
                        <p class="wow fadeInLeft"
                           data-wow-duration="1.5s">{{__('TFA Plc owns different Properties in strategic areas where Tanzanians can be able to open up different Entrepreneur Activities. “TFA PLAZA”')}}</p>
    ...
    <div class="landing_dash">
        <img class="" src="{{ asset('assets/images/landing/tfa.jpg') }}" alt="">
    </div>
</section>
<!-- intro end-->
<!-- demo start-->
            ...
            <div class="ecompro-slide arrow-style1">
                    ...
                    <div class="card ecom-product">
                        <div class="card-body p-10">
                            <div class="product-imgwrap"><img style="height: 100px" class="img-fluid"
                                                              src="{{ asset('assets/images/landing/prime_location.png') }}"
                                                              alt="1.jpg"></div>
                            <div class="detail-wrap">
                                <a href="#">
                                    <h5>{{__('Prime Location')}}</h5>
                                    <p>{{__('Located in a prime area, making it easily accessible for employees, clients, and suppliers. High visibility location can attract more foot traffic and enhance brand presence.')}}</p>
                                </a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card ecom-product">
                        <div class="card-body p-10">
                            <div class="product-imgwrap"><img style="height: 180px"  class="img-fluid"
                                                              src="{{ asset('assets/images/landing/flexibility.png') }}"
                                                              alt="1.jpg"></div>
                            <div class="detail-wrap">
                                <a href="#">
                                    <h5>{{__('Flexibility')}}</h5>
                                    <p>{{__('Options to customize the office space according to the specific needs of the business. Offering flexible lease terms to accommodate the growth and changes in the business.')}}</p>
                                </a>
                            </div>
                        </div>
                    </div>
                ...
                <div>
                    <div class="card ecom-product">
                        <div class="card-body p-10">
                            <div class="product-imgwrap"><img style="height: 180px" class="img-fluid"
                                                              src="{{ asset('assets/images/landing/cost_effective.jpeg') }}"
                                                              alt="1.jpg"></div>
                            <div class="detail-wrap">
                                <a href="#">
                                    <h5>{{__('Cost-Effective')}}</h5>
                                    <p>{{__('Affordable rental rates compared to other properties in the area. Utilities, maintenance, and security included in the rental package, reducing additional costs.')}}</p>
                                </a>
                            </div>
                        </div>
                    </div>
                ...
                <div>
                    <div class="card ecom-product">
                        <div class="card-body p-10">
                            <div class="product-imgwrap"><img style="height: 180px" class="img-fluid"
                                                              src="{{ asset('assets/images/landing/support.png') }}"
                                                              alt="1.jpg"></div>
                            <div class="detail-wrap">
                                <a href="#">
                                    <h5>{{__('Support Services')}}</h5>
                ...
                <div>
                    <div class="card ecom-product">
                        <div class="card-body p-10">
                            <div class="product-imgwrap"><img style="height: 180px" class="img-fluid"
                                                              src="{{ asset('assets/images/landing/convenience.png') }}"
                                                              alt="1.jpg"></div>
                            <div class="detail-wrap">
                                <a href="#">
                                    <h5>{{__('Convenience')}}</h5>
                                    <p>{{__('Property management refers to the administration, operation, and oversight of real estate properties on behalf of property owners.')}}</p>
                                </a>
                            </div>
                        </div>
                ...
                <div class="col-xxl-3 cdx-xl-50 col-sm-6">
                    <div class="codex-pricingtbl">
                        <div class="price-header">
                            ...
                            <div class="price-value">{{subscriptionPaymentSettings()['CURRENCY_SYMBOL']}}10<span>/ M square</span></div>
                        </div>
            ...
            @foreach($subscriptions as $subscription)
                <div class="col-xxl-3 cdx-xl-50 col-sm-6">
                    <div class="codex-pricingtbl">
                        <div class="price-header">
                            <h2>{{$subscription->title}}</h2>
                            <div class="price-value">{{subscriptionPaymentSettings()['CURRENCY_SYMBOL']}}20<span>/ M square</span></div>
                        </div>
                        {{-- <ul class="cdxprice-list">
                            <li><span> <i class="text-success mr-4" data-feather="check-circle"></i>{{$subscription->user_limit}}</span>{{__('User Limit')}}</li>
                            <li><span> <i class="text-success mr-4" data-feather="check-circle"></i>{{$subscription->property_limit}}</span>{{__('Property Limit')}}</li>
            ...
            @foreach($subscriptions as $subscription)
                <div class="col-xxl-3 cdx-xl-50 col-sm-6">
                    <div class="codex-pricingtbl">
                        <div class="price-header">
                            <h2>{{$subscription->title}}</h2>
                            <div class="price-value">{{subscriptionPaymentSettings()['CURRENCY_SYMBOL']}}30<span>/ M square</span></div>
                        </div>
                        {{-- <ul class="cdxprice-list">
                            <li><span> <i class="text-success mr-4" data-feather="check-circle"></i>{{$subscription->user_limit}}</span>{{__('User Limit')}}</li>
                            <li><span> <i class="text-success mr-4" data-feather="check-circle"></i>{{$subscription->property_limit}}</span>{{__('Property Limit')}}</li>
            ...
            @foreach($subscriptions as $subscription)
                <div class="col-xxl-3 cdx-xl-50 col-sm-6">
                    <div class="codex-pricingtbl">
                        <div class="price-header">
                            <h2>{{$subscription->title}}</h2>
                            <div class="price-value">{{subscriptionPaymentSettings()['CURRENCY_SYMBOL']}}40<span>/ M square</span></div>
                        </div>
                        {{-- <ul class="cdxprice-list">
                            <li><span> <i class="text-success mr-4" data-feather="check-circle"></i>{{$subscription->user_limit}}</span>{{__('User Limit')}}</li>
                            <li><span> <i class="text-success mr-4" data-feather="check-circle"></i>{{$subscription->property_limit}}</span>{{__('Property Limit')}}</li>
...
<section class="space-py-100" id="features">
    <div class="container">
        <div class="row">
            <div class="col-lg-8 offset-lg-2 col-md-10 offset-md-1">
                <div class="land-title">
                    <h2 class="wow fadeInUp" data-wow-duration="1s">{{__('SPACE AVAILABLE')}} </h2>
                </div>
            </div>
        </div>
        <div class="row cdx-row">
            <div class="col-lg-4 col-md-6 wow fadeInUp">
                <div class="demo-grid">
                    <div class="img-wrap"><img class="img-fluid"
                                               src="{{ asset('assets/images/landing/room1.jpeg') }}"
                                               alt="">
                        <div class="group-link"><a class="hover-link"
                                                   href="javascript:void(0);"><img
                                    class="img-fluid"
                                    src="{{ asset('assets/images/landing/room2.jpeg') }}"
            ...
            <div class="col-lg-4 col-md-6 wow fadeInUp">
                <div class="demo-grid">
                    <div class="img-wrap"><img class="img-fluid"
                                               src="{{ asset('assets/images/landing/room3.jpeg') }}"
                                               alt="">
                        <div class="group-link"><a class="hover-link"
                                                   href="javascript:void(0);"><img
                                    class="img-fluid"
...
<section class="landheader-comp space-py-100 overflow-visible" id="faq">
    <div class="container">
        <div class="row">
            <div class="col-lg-8 offset-lg-2 col-md-10 offset-md-1">
                <div class="land-title">
                    <h2 class="wow fadeInLeft">{{__(' Ask Questions?')}}</h2>
                </div>
            </div>
        </div>
        <div class="row pricing-grid">
