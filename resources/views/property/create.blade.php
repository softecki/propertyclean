            ...
            <div class="card">
                <div class="card-body">
                    <div class="info-group">
                        ...
                        <div class="form-group">
                            {{Form::label('name',__('Property Name/Building'),array('class'=>'form-label'))}}
        ...
        <div class="col-lg-6">
            <div class="card">
                <div class="card-body">
                    <div class="info-group">
                        <div class="form-group">
                            {{Form::label('plot_no',__('Plot No'),array('class'=>'form-label'))}}
                            {{Form::text('plot_no',null,array('class'=>'form-control','placeholder'=>__('Enter Plot No')))}}
                        </div>
                        <div class="form-group">
                            {{Form::label('title_deed_no',__('Title Deed No'),array('class'=>'form-label'))}}
                            {{Form::text('title_deed_no',null,array('class'=>'form-control','placeholder'=>__('Enter Title Deed No')))}}
                        </div>
                        <div class="form-group">
                            {{Form::label('property_size',__('Property Size(Square Meters)'),array('class'=>'form-label'))}}
                            {{Form::text('property_size',null,array('class'=>'form-control','placeholder'=>__('Enter Property Size(Square Meters)')))}}
                        </div>
                        <div class="form-group">
                            {{Form::label('city',__('Disctrict'),array('class'=>'form-label'))}}
                            {{Form::text('city',null,array('class'=>'form-control','placeholder'=>__('Enter Property District')))}}
                        </div>
                        <div class="form-group">
                            {{Form::label('zip_code',__('Region'),array('class'=>'form-label'))}}
                            {{Form::text('zip_code',null,array('class'=>'form-control','placeholder'=>__('Enter Property Region ')))}}
                        </div>
                        <div class="form-group ">
