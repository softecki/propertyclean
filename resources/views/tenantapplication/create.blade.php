...
@endsection
@section('content')
    {{Form::open(array('url'=>'tenant','method'=>'post', 'files' => true, "id"=>"tenant_form"))}}
    <div class="row">
        <div class="col-lg-6">
            <div class="card">
                    ...
                    <div class="info-group">
                        <div class="row">
                            ...
                            <div class="form-group">
                                {{Form::label('bank_statement',__('Bank Statement'),array('class'=>'form-label'))}}
                                {{Form::file('bank_statement',array('class'=>'form-control'))}}
                            </div>

                            <div class="form-group">
                                {{Form::label('contract',__('Previous Lease Contract'),array('class'=>'form-label'))}}
                                {{Form::file('contract',array('class'=>'form-control'))}}
                            </div>
                            <div class="form-group">
                                {{Form::label('memorandum',__('Memorandum of Association'),array('class'=>'form-label'))}}
                                {{Form::file('memorandum',array('class'=>'form-control'))}}
                            </div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="info-group">
                        <div class="row">
                            <div class="form-group col-lg-6 col-md-6">
                                {{Form::label('business_name',__('Business Name'),array('class'=>'form-label'))}}
                                {{Form::text('business_name',null,array('class'=>'form-control','placeholder'=>__('Enter Business name')))}}
                            </div>
                            <div class="form-group col-lg-6 col-md-6">
                                {{Form::label('business_number',__('Business Registration Number'),array('class'=>'form-label'))}}
                                {{Form::text('business_number',null,array('class'=>'form-control','placeholder'=>__('Enter Business Registration Number')))}}
                            </div>
                            <div class="form-group col-lg-6 col-md-6">
                                {{Form::label('tax_payer_identification',__('Tax Payer Identification'),array('class'=>'form-label'))}}
                                {{Form::text('tax_payer_identification',null,array('class'=>'form-control','placeholder'=>__('Enter Tax Payer Identification')))}}
                            </div>
                            <div class="form-group col-lg-6 col-md-6">
                                {{Form::label('contact_information',__('Contact Information'),array('class'=>'form-label'))}}
                                {{Form::text('contact_information',null,array('class'=>'form-control','placeholder'=>__('Enter Contact Information')))}}
                            </div>
                            <div class="form-group ">
                                {{Form::label('company_name',__('Company Name'),array('class'=>'form-label'))}}
                                {{Form::textarea('company_name',null,array('class'=>'form-control','rows'=>5,'placeholder'=>__('Enter Company Name')))}}
                            </div>
                            <div class="form-group">
                                {{Form::label('trading_licence',__('Valid Trading Licence'),array('class'=>'form-label'))}}
                                {{Form::file('trading_licence',array('class'=>'form-control'))}}
                            </div>
                            <div class="form-group">
                                {{Form::label('application_flow',__('Approval Flow of Application'),array('class'=>'form-label'))}}
                                {{Form::file('application_flow',array('class'=>'form-control'))}}
                            </div>
                        </div>
                    </div>
                </div>
